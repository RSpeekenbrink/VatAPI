...
class DataParser extends VatsimParser
{
    ...
    /** The current processor is stored here */
     ...
     * Process a data line
     *
     * @param string string of the data line
     * @return null
     */
    ...
    /**
     * Process a general data line
     *
     *  @param string string of 1 data entry
     *  @return null
     */
    ...
    /**
     * Process a Voice Server data line
     *
     *  @param string string of 1 data entry
     *  @return null
     */
    ...
    /**
     * Process a Prefiled Flightplan data line
     *
     *  @param string string of 1 data entry
     *  @return null
     */
    ...
    /**
     * Parse a clientdata line to an array
     *
     *  @param string string of 1 data entry
     *  @return array clientdata in an array
     */
    ...
    /**
     * Get a string between 2 characters
     *
     *  @param string string to search in
     *  @param string character to start with
     *  @param string character to end with
     *  @return string the string between the start and end characters
     */
    ...
    /**
     * Parse the data and return it as array
     *
     *  @return array data
     */
    ...
    /**
     * Parse only client data and return it as array
     *
     *  @return array data
     */
